                ...
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="<?php $_SERVER['PHP_SELF']; ?>" novalidate method="post">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Assessment Code" required name="AssessmentCode">
                            <br>
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block" style="background-color:#339e69;border-color: #339e69" ><i class="icon-unlock2"></i> Check Assessment</button>
                    </form>
                </div>
            </div>
